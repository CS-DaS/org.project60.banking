...
class CRM_Banking_PluginImpl_Matcher_CreateContactAndContribution extends CRM_Banking_PluginModel_Matcher {
  ...
  public function execute($suggestion, $btx) {
    ...
    $suggestion->setParameter('contribution_id', $result[0]['id']);

    // save the account
    $this->storeAccountWithContact($btx, $contact_id);

    // link the contribution
    CRM_Banking_BAO_BankTransactionContribution::linkContribution($btx->id, $result[0]['id']);
   ...
   *
   * @val $suggestion    suggestion data as previously generated by this plugin instance
