 ...
 * @group headless
 */
class CRM_Banking_Matcher_CreateContactAndContributionMatcherTest extends CRM_Banking_TestBase {
  ...
  public function testContributionMatcherFires():void {
    ...
    if ($previous_contact) {
      $this->assertNotEquals($created_contact['id'], $previous_contact['id'], 'No contact created!');
    }
    static::assertArrayHasKey(
      'contact_source',
      $created_contact,
    ...
    $this->assertEquals($created_contact['contact_source'], $transaction_source,
                        'Source was not passed to the created contact');
    $this->assertEquals($created_contact['first_name'], $first_name,
                        'First name was not passed to the created contact');
    $this->assertEquals($created_contact['last_name'], $last_name,
